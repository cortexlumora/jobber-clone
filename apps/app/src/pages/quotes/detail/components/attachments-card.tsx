...
const AttachmentsCard = ({ files, onAdd, onRemoveFile, onRemoveSection, saving }: AttachmentsCardProps) => {
	...
	return (
		<div className="rounded-xl px-2 border bg-background">
			<div className="py-4 px-2 flex items-center justify-between">
				...
				<Button variant="ghost" size="sm" className="h-7 text-xs" onClick={onRemoveSection} disabled={saving}>
